...
<div align="center">
  <strong>A GeekCash blockchain REST and WebSocket API Service</strong>
</div>
<br />
<div align="center">
  <!-- NPM version -->
  <a href="https://npmjs.org/package/@geekcash/insight-api">
    <img src="https://img.shields.io/npm/v/@geekcash/insight-api.svg?style=flat-square" alt="NPM version" />
  </a>
</div>


This is a backend-only service. If you're looking for the web frontend application, take a look at https://github.com/geekcash/insight-ui.
...
- [Resources](#resources)
- [License](https://github.com/geekcash/insight-api/blob/master/LICENSE)

## Getting Started

```bashl
npm install -g geekcash-node@latest
geekcash-node create mynode
cd mynode
geekcash-node install insight-api
geekcash-node start
```
...
- [GeekCash Node ](https://github.com/geekcash/geekcash-node)

**Note:** You can use an existing GeekCash data directory, however `txindex`, `addressindex`, `timestampindex` and `spentindex` needs to be set to true in `geekcash.conf`, as well as a few other additional fields.
...
```
With all the configuration options available: https://github.com/geekcash/insight-api/blob/master/lib/ratelimiter.js#L10-17
...
```
{
  "result":"[[\"proposal\",{\"end_epoch\":1519848619,\"name\":\"ghijklmnopqrstuvwxyz01234567891519097947\",\"payment_address\":\"yik5HAgVAgjH1oZKjcDfvcf22bwBNbSYzB\",\"payment_amount\":10,\"start_epoch\":1519097947,\"type\":1,\"url\":\"https://www.geekcashcentral.org/p/test_proposal_1519097947\"}]]",
  "error":null,
  "id":78637
}
```
...
- (Medium)[How to setup a GeekCash Instant-Send Transaction using Insight API?????????The comprehensive way](https://medium.com/@obusco/setup-instant-send-transaction-the-comprehensive-way-a80a8a0572e)
